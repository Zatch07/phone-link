...
Item {
    ...
    readonly property var _device: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeDevice
    ...
    RowLayout {
        ...
        RippleButton {
            id: deviceChip
            property var pairedDevices: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).devices
                                                    .filter(d => d.paired)
            ...
            enabled: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).hasDevices && pairedDevices.length > 0
            ...
            contentItem: RowLayout {
                ...
                StyledText {
                    ...
                    text: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeDevice
        ...
        Rectangle {
            ...
            opacity: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeReachable ? 1.0 : 0.4
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                onClicked: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {})._probeAdb()
            }
        }
    }
}
