...
Item {
    ...
    function dismissAllOnPhone() {
        root.notifications.forEach(notif => {
            (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).discardNotification(notif.publicId)
        })
    }
        ...
        onClicked: mouse => {
            ...
            // without expanding the group first.
                ...
                if (latest && latest.publicId) {
                    (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).openNotificationIntent(latest.publicId)
                }
            }
        }
        onDraggingChanged: () => {
                ...
                Item {
                    ...
                    RowLayout {
                        ...
                        StyledText {
                            ...
                            text: {
                                (ExtensionServices.loaded["phone-link.KdeConnectService"] || {})._timeTick
