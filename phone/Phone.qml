 ...
 *
 * Backed by `(ExtensionServices.loaded["phone-link.KdeConnectService"] || {})` which mirrors the KDE Connect daemon into a
    ...
    Rectangle {
        ...
        Connections {
            ...
            function onActiveDeviceBatteryLow(devId, charge) {
                const name = (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeDevice
                    ? (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeDevice.name
        ...
        Connections {
            target: (ExtensionServices.loaded["phone-link.PhoneCameraService"] || {})
            ignoreUnknownSignals: true
        ...
        Connections {
            target: (ExtensionServices.loaded["phone-link.PhoneMicService"] || {})
            ignoreUnknownSignals: true
            function onErrorOccurred(message) {
                toastLayer.show(message.split("\n")[0], false)
            }
            ...
            Rectangle {
                ...
                ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            id: recentRepeater
                            model: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).recentDevices
                            delegate: RippleButton {
                                ...
                                onClicked: () => {
                                    (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).selectDevice(modelData?.id)
                    ...
                    Repeater {
                        model: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).devices.filter(d => d.paired)
                        delegate: RippleButton {
                            id: deviceMenuItem
                            required property var modelData
                            Layout.fillWidth: true
                            Layout.preferredHeight: 40
                            buttonRadius: Appearance.rounding.small
                            colBackground: modelData?.id === (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeDeviceId
                                ? Appearance.colors.colPrimaryContainer
                                : "transparent"
                            colBackgroundHover: modelData?.id === (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeDeviceId
                            ...
                            contentItem: RowLayout {
                                ...
                                MaterialSymbol {
                                    ...
                                    text: "smartphone"
                                    iconSize: Appearance.font.pixelSize.normal
                                    color: modelData?.id === (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeDeviceId
                                        ? Appearance.colors.colOnPrimaryContainer
                                        : (modelData?.reachable
                                            ? Appearance.colors.colOnLayer2
                                            : Appearance.colors.colSubtext)
                                ...
                                MaterialSymbol {
                                    Layout.alignment: Qt.AlignVCenter
                                    text: modelData?.id === (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeDeviceId
                                        ? "check_circle"
                                        : (modelData?.reachable
                                            ? "radio_button_unchecked"
                                            : "do_not_disturb_on")
                    ...
                    RippleButton {
                        ...
                        onClicked: {
                            (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).refreshDevices()
                            deviceMenuOverlay.visible = false
                        }
                    }
                }
        ...
        ColumnLayout {
            ...
            Repeater {
                model: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).pendingPairRequests
                delegate: Rectangle {
                    required property var modelData
                    Layout.fillWidth: true
                    ...
                    RowLayout {
                        ...
                        RippleButton {
                            ...
                            onClicked: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).declinePairing(modelData?.id)
                            StyledToolTip {
                        ...
                        RippleButton {
                            ...
                            onClicked: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).acceptPairing(modelData?.id)
                        }
                    }
                }
            }
            ...
            Item {
                ...
                RowLayout {
                    ...
                    RippleButtonWithIcon {
                        ...
                        onClicked: () => (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).requestNotificationsRefresh()
                        StyledToolTip {
                    ...
                    RippleButtonWithIcon {
                        ...
                        opacity: 1.0
                        materialIcon: ""
                        mainText: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeReachable
                                    ? Translation.tr("%1 notif.").arg(
                                        String((ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).notificationCount))
                    ...
                    RippleButtonWithIcon {
                        ...
                        colBackground: Appearance.colors.colLayer2
                        colBackgroundHover: Appearance.colors.colLayer2Hover
                                                enabled: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).available
                                   && (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).activeReachable
                                   && (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).hasDevices
                                   && (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).notificationCount > 0
                        opacity: enabled ? 1.0 : 0.5
                        materialIcon: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).notificationCount > 0
                                    ? "delete_sweep"
                                    : "do_not_disturb_on"
                        mainText: ""
                        background: Rectangle {
                        ...
                        onClicked: () => (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).discardAllNotifications()
                        StyledToolTip {
            ...
            ColumnLayout {
                ...
                MaterialSymbol {
                    Layout.alignment: Qt.AlignHCenter
                    text: (ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).available
                ...
                RippleButton {
                    ...
                    visible: !(ExtensionServices.loaded["phone-link.KdeConnectService"] || {}).available
                    contentItem: RowLayout {
                        spacing: 6
                        MaterialSymbol {
                            Layout.alignment: Qt.AlignVCenter
